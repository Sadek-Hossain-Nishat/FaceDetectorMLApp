...
public class FaceDetectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addContentView(boxView, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
                ...
                try {
                    ...
                    imageAnalyzer.setAnalyzer(cameraExecutor,
                            new FaceAnalyser(
                                    ...
                                    binding.graphicOverlayFaceDetection
                            ));
